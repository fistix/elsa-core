...
class SelectMessagingSmsField {
    constructor(hostRef) {
        ...
        this.toggleModal = () => {
            $("#smsTemplateDetailsModal").modal('hide');
        }
    ...
    refresh() {
        document.getElementById(this.name).value = msgModel.template; //JSON.stringify(msgModel);
    ...
    render() {
        ...
        return (h(Host, null,
            ...
            h("button", { type: "button", class: "btn btn-default", "data-toggle": "modal", "data-target": "#smsTemplateDetailsModal" }, "View Template Details"),
            ),

            h("div", { class: "modal fade smsTemplateDetailsModal", id: "smsTemplateDetailsModal", tabindex: "-1", role: "dialog", "aria-labelledby": "smsTemplateDetailsModalLabel", "aria-hidden": "true" },
                h("div", { class: "modal-dialog rounded border border-info", role: "document" },
                    h("div", { class: "modal-content" },
                        h("div", { class: "modal-header" },
                            h("h5", { class: "modal-title", id: "smsTemplateDetailsModalLabel" }, "Template Details"),
